        ...
        for arch_result in dataset.iterdir():
            ...
            for result in arch_result.glob("*.pickle"):
                ...
                try:
                    ...
                    sensitivity = experiment_results["tp"][best_idx] / (
                                experiment_results["tp"][best_idx] + experiment_results["fn"][best_idx])
                    specificity = experiment_results["tn"][best_idx] / (
                                experiment_results["tn"][best_idx] + experiment_results["fp"][best_idx])
