...
for dataset in datasets.iterdir():
    ...
    mlp_archs = [
        ...
        [input_size, input_size - int(0.6 * input_size)],
        [input_size, input_size - int(0.7 * input_size)],
        [input_size, input_size - int(0.8 * input_size)],
        [input_size, input_size - int(0.9 * input_size)],
